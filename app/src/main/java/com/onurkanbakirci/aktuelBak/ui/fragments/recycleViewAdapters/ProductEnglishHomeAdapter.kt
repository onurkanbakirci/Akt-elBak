...
class ProductEnglishHomeAdapter (private val mProducts : List<Product>, val mContext: Context): RecyclerView.Adapter<ProductEnglishHomeAdapter.ProductsViewHolder>() {
